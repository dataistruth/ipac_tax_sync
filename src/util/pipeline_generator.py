...
from util.schema_generator import format_schema_resource_lines, schema_resource_key
...
def generate_client_pipelines_yaml(
    ...
    client_schema_lines = format_schema_resource_lines(
        raw_schema,
        uc_catalog_ref,
    ...
    lines.extend(client_schema_lines)
    lines.extend(
        [
            "  pipelines:",
        ]
